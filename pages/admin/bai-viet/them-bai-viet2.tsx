...
const App: React.FC = () => {
  ...
  useMemo(() => {
    ...
    handleCategoryClient
      .handleGetAllCategory("language=VI")
      .then((result: any) => {
  ...
  const itemCKeditor: TabsProps["items"] = [
    {
      ...
      children: (
        <>
          <label className='admin__main-label'>Tiêu đề bài viết</label>
          <Input
            ...
            value={title.PO}
          />
          <label className='admin__main-label'>Mô tả ngắn cho bài viết</label>
          <TextArea
            showCount
            maxLength={400}
    ...
    <Dashboard>
      <div className='admin__main-wrap'>
        <NavigationAdmin
          ...
          description={
            "Soạn thảo bài viết tin tức bằng trình soạn thảo văn bản"
          }
          data={navigationData}
        />
