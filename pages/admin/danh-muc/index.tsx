...
const App: React.FC = () => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      title: "Đường dẫn",
      dataIndex: "link",
      render: (link, record: any) => <>{ record.linkParent ? process.env.NEXT_PUBLIC_FULL_URL + "/san-pham"+ record.linkParent + link :  process.env.NEXT_PUBLIC_FULL_URL+"/san-pham" + link}</>
    },
    {
      title: "Danh mục cha",
